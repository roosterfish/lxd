...
func (c *cmdNetworkLoadBalancerPool) runCreate(cmd *cobra.Command, args []string) error {
	...
	loadBalancerPool := api.NetworkLoadBalancerPoolPost{
		Name: args[1],
...
### Any line starting with a '# will be ignored.
###
### A network load balancer pool consists of a set of instances (which optional port) and healtcheck configuration.
###
### An example would look like:
### name: pool1
### description: ""
