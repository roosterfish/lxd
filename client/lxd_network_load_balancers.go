...
func (r *ProtocolLXD) CreateNetworkLoadBalancerPool(networkName string, pool api.NetworkLoadBalancerPoolPost) error {
	...
	// Send the request.
	u := api.NewURL().Path("networks", networkName, "load-balancers-pools")
...
func (r *ProtocolLXD) GetNetworkLoadBalancerPool(networkName string, poolName string) (*api.NetworkLoadBalancerPool, string, error) {
	...
	// Send the request.
	u := api.NewURL().Path("networks", networkName, "load-balancers-pools", poolName)
...
func (r *ProtocolLXD) GetNetworkLoadBalancerPoolState(networkName string, poolName string) (*api.NetworkLoadBalancerPoolState, error) {
	...
	// Send the request.
	u := api.NewURL().Path("networks", networkName, "load-balancers-pools", poolName, "state")
