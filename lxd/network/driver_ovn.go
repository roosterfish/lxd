...
func (n *ovn) checkPoolHealthCheck(pool *api.NetworkLoadBalancerPool) (*loadBalancerHealthCheck, error) {
	...
	if ok {
		successCount, err = strconv.ParseUint(successCountStr, 10, 32)
		if err != nil {
	...
	if ok {
		failureCount, err = strconv.ParseUint(failureCountStr, 10, 32)
		if err != nil {
...
func (n *ovn) loadBalancerPoolValidate(poolName string, pool api.NetworkLoadBalancerPoolPut) (*dbCluster.NetworksLoadBalancerPool, error) {
	...
	rules := map[string]func(value string) error{
		...
		"healthcheck.interval": validate.Optional(validate.IsUint32),
		...
		"healthcheck.timeout": validate.Optional(validate.IsUint32),
		...
		"healthcheck.success_count": validate.Optional(validate.IsUint32),
		...
		"healthcheck.failure_count": validate.Optional(validate.IsUint32),
	}
